...
export default function CronTool() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-14">
      <Link href="/welcome" className="mb-10 flex items-center gap-2 font-semibold"><span className="dot dot-healthy" />CronSentinel</Link>
      ...
      <p className="mt-10 text-sm text-mute">Want to know when this schedule <em>doesn't</em> run? <Link href="/login" className="underline">Monitor it with CronSentinel</Link>.</p>
    </main>
  );
}
